...
import DEFAULT_SAFE_SCHEMA from './schema/default_safe.js';
import DEFAULT_FULL_SCHEMA from './schema/default_full.js';
...
export function loadAll(input, iterator, options) {
...
export function safeLoadAll(input, output, options) {
    if (options === void 0) { options = {}; }
